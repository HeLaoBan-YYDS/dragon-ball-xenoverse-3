      ...
      <section className="text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <Button asChild size="lg">
            <Link href={localizeHref(BEGINNER_GUIDE_HREF, locale)}>{home.hero.primaryCta}<ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
          <Button asChild size="lg" variant="outline">
            <Link href={PLAYSTATION_WISHLIST_HREF}>{home.hero.secondaryCta}</Link>
          </Button>
          <Button asChild size="lg" variant="outline">
            <Link href={XBOX_WISHLIST_HREF}>{home.hero.tertiaryCta}</Link>
          </Button>
        </div>
      </section>

      {/* 最近更新 + 新手教程 两栏布局 */}
      <section aria-label="Dragon Ball Xenoverse 3 official trailer" className="mx-auto w-full max-w-5xl">
